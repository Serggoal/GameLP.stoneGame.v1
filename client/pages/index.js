  ...
  const initConnection = async () => {
    if (typeof window.ethereum !== 'undefined') {
      ...
      if (network.chainId != 80001) {
        ...
        setContract(
          new ethers.Contract(
            '0x12dEe21b3b70A64aF2423a3171f65A87f09e066E',[
                {
                    "inputs": [],
        ...
        setContractGameSinger(
          new ethers.Contract(
            '0xd44Bc55c217765B9FF2B95B81FB29f7200AA4450',[
                {
                    "inputs": [],
                    "name": "depo",
                    "outputs": [],
        ...
        setContractChainlinkSinger(
          new ethers.Contract(
            '0xE14d0F3A24E47793a14351dD56eBC5D4801878bD',[
                {
                    "inputs": [
                        {
                            "internalType": "uint256",
        ...
        const balanceOfContract = await provider.getBalance("0x12dEe21b3b70A64aF2423a3171f65A87f09e066E");
